...
### Changed
- **Simplified efficiency page filters** — Removed the Generation filter row, keeping just Vehicle (R1T/R1S) and Battery (Standard/Large/Max). Selecting a vehicle narrows the available battery options.
