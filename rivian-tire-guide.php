...
function rtg_init() {
    ...
    // Owner-facing release notes: /tire-guide/whats-new/ and the guide's modal.
    new RTG_Whats_New();

    // AI Tire Advisor: Help me choose, What owners say, the compare paragraph.
    new RTG_Advisor();
}
